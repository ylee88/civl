...
\item Install the automated theorem prover CVC3 (if you have not
  ...
  linux systems, CVC3 can be installed using the package manager via
  \texttt{sudo apt-get install cvc3}.  This will place \texttt{cvc3}
  in \texttt{/usr/bin}.
...
\item Install the automated theorem prover CVC4 (if you have not
  ...
  and you must put it in your \texttt{PATH}.
...
\item From the command line, type \texttt{civl config}.  This should
  report that \texttt{cvc3} and \texttt{cvc4} were found, and it should
  create a file called \texttt{.sarl} in your home directory.
