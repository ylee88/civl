...
public interface Expression extends Sourceable {
	...
	public enum ExpressionKind {
		ADDRESS_OF, BINARY, BOOLEAN_LITERAL, BOUND_VARIABLE, CAST, COND, DEREFERENCE, DOT, DYNAMIC_TYPE_OF, INITIAL_VALUE, INTEGER_LITERAL, NULL_LITERAL, QUANTIFIER, REAL_LITERAL, RESULT, SELF, SIZEOF_TYPE, SIZEOF_EXPRESSION, STRING_LITERAL, SUBSCRIPT, UNARY, UNDEFINED_PROC, VARIABLE
	}
