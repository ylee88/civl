...
public interface Expression extends Sourceable {
	...
	public enum ExpressionKind {
		ABSTRACT_FUNCTION_CALL, ADDRESS_OF, ARRAY_LITERAL, BINARY, BOOLEAN_LITERAL, BOUND_VARIABLE, CAST, CHAR_LITERAL, COND, DEREFERENCE, DERIVATIVE, DOT, DYNAMIC_TYPE_OF, FUNCTION_POINTER, FUNCTION_GUARD, INITIAL_VALUE, INTEGER_LITERAL, NULL_LITERAL, QUANTIFIER, REAL_LITERAL, RESULT, SCOPEOF, SELF, SIZEOF_TYPE, SIZEOF_EXPRESSION, STRING_LITERAL, STRUCT_OR_UNION_LITERAL, SUBSCRIPT, SYSTEM_GUARD, UNARY, UNDEFINED_PROC, VARIABLE, WAIT_GUARD, HERE_OR_ROOT, PROC_NULL, SYSTEM_FUNC_CALL
	}
