...
public class CIVLException extends RuntimeException {
	...
	public enum ErrorKind {
		ARRAY_DECLARATION, ASSERTION_VIOLATION, ARRAY_LAMBDA, COMMUNICATION, CONSTANT_WRITE, CONTRACT, CYCLE, DEADLOCK, DEREFERENCE, DIVISION_BY_ZERO, FUNCTIONAL_COMPATIBILITY, INPUT_WRITE, INT_DIVISION, INTERNAL, INVALID_CAST, INVALID_PID, INVARIANT_VIOLATION, LIBRARY, MALLOC, MEMORY_LEAK, MPI_ERROR, OTHER, OUT_OF_BOUNDS, OUTPUT_READ, POINTER, QUANTIFIER, PRINTF, SIZEOF, INVALID_WAIT, UNDEFINED_VALUE, UNION, PROCESS_LEAK, SEQUENCE, FUNCTIONAL_EQUIVALENCE, MEMORY_MANAGE,
	}
