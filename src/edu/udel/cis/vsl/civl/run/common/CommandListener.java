...
public interface CommandListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link CommandParser#specOrImplCommand}.
	 * @param ctx the parse tree
	 */
	void enterSpecOrImplCommand(@NotNull CommandParser.SpecOrImplCommandContext ctx);
	/**
	 * Exit a parse tree produced by {@link CommandParser#specOrImplCommand}.
	 * @param ctx the parse tree
	 */
	void exitSpecOrImplCommand(@NotNull CommandParser.SpecOrImplCommandContext ctx);
	/**
