/*********************************************************************
  ...
  Objective           : Write an MPI-OpenMP Program to perform Matrix-Vector
                        Multiplication
  
  Input               : Process 0 reads files (mdata.inp) for Matrix and
                        (vdata.inp) for Vector
...
main(int argc, char **argv)
{
  ...
  float         **Matrix, *Buffer, *Mybuffer, *Vector, *MyFinalVector,
    *FinalVector;
