...
int hypre_NumActiveThreads( void );
...
#define hypre_PrintTiming(heading, wall_time_ptr, comm)
...
int hypre_PrintTiming( const char *heading , double *wall_time_ptr, MPI_Comm comm );
...
void hypre_BigSwapbi ( HYPRE_BigInt *v , int *w , int i , int j );
void hypre_BigQsortbi ( HYPRE_BigInt *v , int *w , int left , int right );
void hypre_BigSwapLoc ( HYPRE_BigInt *v , int *w , int i , int j );
void hypre_BigQsortbLoc ( HYPRE_BigInt *v , int *w , int left , int right );
void hypre_BigSwapb2i ( HYPRE_BigInt *v , int *w , int *z , int i , int j );
void hypre_BigQsortb2i ( HYPRE_BigInt *v , int *w , int *z , int left , int right );
void hypre_BigSwap ( HYPRE_BigInt *v , int i , int j );
void hypre_BigQsort0 ( HYPRE_BigInt *v , int left , int right );
