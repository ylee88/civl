...
@header {
  ...
  import dev.civl.abc.front.fortran.parse.IActionEnums;
}*/
...
@members {
   ...
   public void initialize(String[] args, String filename, String path) {
      action = new FortranParserActionTreeMaker(args, this, filename); 
