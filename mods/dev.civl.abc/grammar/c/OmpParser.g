...
simd_clause
  : SAFELEN LPAREN e=expression RPAREN
    -> ^(SAFELEN $e)
  | SIMDLEN LPAREN e=expression RPAREN
    -> ^(SIMDLEN $e)
    |  if_clause
    |  data_clause
    |  collapse_clause 
    ; //TODO: incompleted, aligned, linear, ...
...
ordered_clause
  :
  ORDERED (LPAREN e1=expression RPAREN)?
  -> ^(ORDERED $e1?)
  ;
