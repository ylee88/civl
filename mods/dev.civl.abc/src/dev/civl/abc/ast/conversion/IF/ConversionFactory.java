...
public interface ConversionFactory {
	...
	/**
	 * <p>
	 * Returns the mem conversion which converts the type of the given
	 * <code>expr</code> to a {@link MemType}. The type of <code>expr</code> may
	 * be pointer type or set-of-pointer type
	 * </p>
	 * 
	 * @param expr
	 *            an expression that will be converted to a $mem type expression
	 * @return a conversion with type of the expr and {@link MemType}
	 * @throws UnsourcedException
	 *             when the old type is not a pointer type or a set of pointer
	 *             type
	 * @throws SyntaxException
	 *             if there is a semantically invalid sub-expression in the
	 *             given expression.
	 */
	MemConversion memConversion(ExpressionNode expr)
