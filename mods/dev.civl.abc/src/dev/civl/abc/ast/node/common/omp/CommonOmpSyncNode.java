...
public class CommonOmpSyncNode extends CommonOmpStatementNode
		implements
			OmpSyncNode {
	...
	public ASTNode setChild(int index, ASTNode child) {
		if (index == 8 && !(child == null || child instanceof SequenceNode))
			throw new ASTException("Child of CommonOmpSyncNode at index "
					+ index + " must be a SequenceNode, but saw " + child
					+ " with type " + child.nodeKind());
		if (index == 9 && !(child == null || child instanceof IdentifierNode))
			throw new ASTException("Child of CommonOmpSyncNode at index "
