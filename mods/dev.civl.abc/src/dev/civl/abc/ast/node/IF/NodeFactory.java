...
>>>>>>> .merge-right.r5973
	...
	/**
	 * Constructs a new generic association node which acts as a binding between
	 * a type node and an expression for the purposes of a generic selection
	 * node
	 * 
	 * @param source
	 *                                 source information for the occurrence of
	 ...
	 * Creates a new OpenMP END node with its type, which indicates what
