 ...
 * node in an AST.</p>
 * 
 * <p>The interface {@link dev.civl.abc.ast.node.IF.ASTNode}
 ...
 * {@link dev.civl.abc.ast.node.IF.NodeFactory}, which specifies
 ...
 * {@link dev.civl.abc.ast.node.IF.AttributeKey}
 * using the appropriate method in the {@link dev.civl.abc.ast.node.IF.NodeFactory}.
