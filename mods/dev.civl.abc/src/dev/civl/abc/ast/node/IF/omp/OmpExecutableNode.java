...
public interface OmpExecutableNode extends OmpNode, StatementNode {
	 ...
	 * <ul>
	 * <li>PARALLEL: the parallel construct</li>
	 ...
	 * single.</li>
	 * <li>SIMD: simd directive, objects of this kind are instances of
	 * {@link OmpSimdNode}</li>
	 * </ul>
	 * 
	...
	public enum OmpExecutableKind {
		PARALLEL, SYNCHRONIZATION, SIMD, WORKSHARING,
	}
	 ...
	 * <ul>
	 * <li><code>firstprivate(x, y, z, ...)</code>: a non-empty sequence
	 * node;</li>
	 ...
	 * clause. There are several possibilities:
	 * <ul>
	 * <li><code>lastprivate(x, y, z, ...)</code>: a non-empty sequence
	 * node;</li>
	 ...
	 * clause. There are several possibilities:
	 * <ul>
	 * <li><code>copyprivate(x, y, z, ...)</code>: a non-empty sequence
	 * node;</li>
