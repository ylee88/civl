...
public class COmpParser implements OmpPragmaParser {
	...
	public static final int SIMD = OmpParser.SIMD;
	public static final int SAFELEN = OmpParser.SAFELEN;
	public static final int SIMDLEN = OmpParser.SIMDLEN;
	...
	public CommonTree parse(Source source, TokenStream tokens)
		...
		try {
			...
			throw new SyntaxException("OpenMP pragma can not be parsed.", source);
		}
	}
}
