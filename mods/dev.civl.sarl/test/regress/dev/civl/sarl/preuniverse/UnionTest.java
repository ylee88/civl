...
public class UnionTest {
	...
	public void setUp() throws Exception {
		...
		union1 = universe.unionType(universe.stringObject("union1"),
		...
		a = universe.arrayWrite(a, universe.integer(0), universe.unionInject(
				union1, universe.intObject(1), universe.rational(2, 3)));
		a = universe.arrayWrite(a, universe.integer(1), universe.unionInject(
				union1, universe.intObject(2), universe.bool(true)));
		a = universe.arrayWrite(a, universe.integer(2), universe.unionInject(
				union1, universe.intObject(0), universe.integer(10)));
	}
	...
	public void extractInject() {
		SymbolicConstant x = universe
				.symbolicConstant(universe.stringObject("x"), union1);
		SymbolicExpression x_real = universe.unionExtract(universe.intObject(1),
				x);
	...
	public void arrayOfUnion() {
		...
		assertEquals(universe.rational(2, 3),
		...
		assertEquals(universe.integer(10),
	...
	public void testCompatibleWithUnion() {
		...
		type5 = universe.unionType(universe.stringObject("Type1"),
	...
	public void typeSequenceSymbolicTypeArray() {
		SymbolicType[] typeArray = { typeFactory.booleanType(),
