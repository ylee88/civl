...
public class SymbolicFunctionTypeTest {
	 ...
	 * variables that is tuple1, tuple2, tuple3.
	 */
	...
	/**
	 * in this test the hash code for two functions is compared with each other
	 * and depending upon the type of function i.e. if they are similar than the
	 * hash codes should be equal and at the same time the hash code for two
	 * different functions should be different.
	 */
	@Test
	public void testComputeHashCode() {
		assertEquals(function.computeHashCode(), function1.computeHashCode());
		assertNotEquals(function1.computeHashCode(),
				function2.computeHashCode());
	...
	/**
	 * this test checks whether one type of function is similar to another type
	 * of function or not.
	 */
	@Test
	public void testTypeEquals() {
		...
		assertNotEquals(function.typeEquals(function1),
				function1.typeEquals(function2));
	}
	...
	/**
	 * this test aims to check the output type of each variable of the ArrayList
	 * of the CommonSymbolicType.
	 */
	@Test
	...
	/**
	 * this test checks the string output of each variable of the ArrayList of
	 * the CommonSymbolicType.
	 */
	@Test
	public void testToStringBuffer() {
		...
		assertEquals(function.toStringBuffer(true).toString(),
				"(<int,bounded,real,float>->int)");
		assertEquals(function1.toStringBuffer(false).toString(),
				"<int,bounded,real,float>->int");
		assertNotEquals(function1.toStringBuffer(false).toString(),
				"(<int,bounded,real,float>->int)");
		assertNotEquals(function2.toStringBuffer(true).toString(),
				"(<int,bounded,real,float>->int)");
	}

	/**
	 * this test check the how many input types the function has, in this
	 * particular test the expected value is 4.
	 */
	@Test
	...
	/**
	 * here the pureType is always returned as null thus the pureType of each
	...
	/**
	 * here the method getPureType always returns null therefore something is
	 * assigned to the variable and checked whether the method getPureType still
	 * returns null or not.
	 */
	@Test
