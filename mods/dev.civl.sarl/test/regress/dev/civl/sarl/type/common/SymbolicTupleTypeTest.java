...
public class SymbolicTupleTypeTest {
	...
	public void setUp() throws Exception {
		...
		tuple1 = new CommonSymbolicTupleType(
				objectFactory.stringObject("Tuple"), typeSequence);
		tuple2 = new CommonSymbolicTupleType(
				objectFactory.stringObject("Tuple"), typeSequence);
		tuple3 = new CommonSymbolicTupleType(
				objectFactory.stringObject("Tuple3"), typeSequence);
	}
