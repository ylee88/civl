...
public class CharTest {
	...
	public void symbolic() {
		SymbolicExpression x = universe
				.symbolicConstant(universe.stringObject("x"), characterType);
		SymbolicExpression y = universe
				.symbolicConstant(universe.stringObject("y"), characterType);
	...
	public void extract() {
		...
		assertEquals(Character.valueOf('a'), a_char);
		assertNull(x_char);
	}
