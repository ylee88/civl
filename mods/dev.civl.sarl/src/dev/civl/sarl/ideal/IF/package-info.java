 ...
 * 
 * <p>
 * The entry point is {@link dev.civl.sarl.ideal.IF.Ideal Ideal2}.
 * That class provides static methods to get a new
 * {@link dev.civl.sarl.ideal.IF.IdealFactory Ideal2Factory}, an
 * implementation of
 * {@link dev.civl.sarl.expr.IF.NumericExpressionFactory}. It also
 ...
 * arithmetic are in package {@link dev.civl.sarl.ideal.common}.
 * </p>
 * 
 * <p>
 * Package {dev.civl.sarl.ideal2.simplify} contains the classes
 ...
 * expressions:
 * <ul>
 * <li>{@link dev.civl.sarl.ideal.IF.Constant Constant}. As you would
 * expect, a constant is a concrete number, like "5" or "3.1415".</li>
 * <li>{@link dev.civl.sarl.ideal.IF.Primitive Primitive}. A primitive
 ...
 * polynomial</li>
 * <li>{@link dev.civl.sarl.ideal.IF.PrimitivePower PrimitivePower}. A
 * power of a primitive. Note that a primitive p is a primitive power, since it
 * can be expressed as p^1.</li>
 * <li>{@link dev.civl.sarl.ideal.IF.Monic Monic}. A monic is a product
