...
public interface SymbolicTypeFactory {
	...
	/**
	 * setting the way you want to comparator to compare two expressions used
	 ...
	 * CommonSymbolicCompleteArrayType(type1) should have the same pureType as
