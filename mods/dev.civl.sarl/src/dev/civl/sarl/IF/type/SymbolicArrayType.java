...
public interface SymbolicArrayType extends SymbolicType {
	...
	/**
	 * @return Returns the base type of any array of this type. The return type
	 *         shall be a non-array type.
	 */
	SymbolicType baseType();

	/**
	 * @return The dimension of any array of this type. Returns a Java "int"
	 *         value.
	 */
	int dimensions();
}
