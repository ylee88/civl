...
public class SlowLoopInvariantsNoAssignsTest {
	...
	public void arrayEquals() {
		assertTrue(ui.run("verify", TestConstants.QUIET,
				"-loop=true", filename("arrayEquals.cvl")));
	}
	...
	public void arrayZeroes2d() {
		assertTrue(ui.run("verify", "-loop=true",
	...
	public void arrayZeroes2d2ColumnsPreserveBadAssert() {
		assertFalse(ui.run("verify", "-loop=true",
				TestConstants.QUIET,
	...
	public void selectSortBadAssert() {
		assertFalse(ui.run("verify", TestConstants.QUIET,
				"-loop=true", TestConstants.errorBound(3),
	...
	public void twoLoopsUnreachable() {
		assertTrue(ui.run("verify", TestConstants.QUIET,
				"-loop=true", filename("twoLoops.cvl")));
	}

	@Test
	public void twoLoopsBad() {
		assertFalse(ui.run("verify", TestConstants.QUIET,
				"-loop=true", filename("twoLoops2.cvl")));
	}
