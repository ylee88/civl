...
public class PthreadCProverTest {
	...
	public void incdec_cas_true() throws ABCException {
		assertTrue(ui.run("verify", filename("04_incdec_cas_true.c"), "-svcomp"));
	}
	...
	public void fmaxsym_cas_true() throws ABCException {
		assertTrue(ui.run("verify", filename("10_fmaxsym_cas_true.c"), "-svcomp"));
	}
	
	@Test
	public void fmaxsymopt_true() throws ABCException {
		assertTrue(ui.run("verify", filename("11_fmaxsymopt_true.c"), "-svcomp"));
	}
	
	@Test
	public void fmaxsymopt_cas_true() throws ABCException {
		assertTrue(ui.run("verify", filename("12_fmaxsymopt_cas_true.c"), "-svcomp"));
	}
	...
	public void read_write_lock_true() throws ABCException {
		assertTrue(ui.run("verify", filename("18_read_write_lock_true.c"), "-svcomp"));
	}
	
	@Test
	public void time_var_mutex_true() throws ABCException {
		assertTrue(ui.run("verify", filename("19_time_var_mutex_true.c"), "-svcomp"));
	}
	...
	public void lu_fig2_fixed_true() throws ABCException {
		assertTrue(ui.run("verify", filename("23_lu-fig2.fixed_true.c"), "-svcomp"));
	}
	...
	public void Boop_simple_vf_false() throws ABCException {
		assertFalse(ui.run("verify", filename("27_Boop_simple_vf_false.c"), "-svcomp"));
	}
	
	@Test
	public void buggy_simple_loop1_vf_false() throws ABCException {
		assertFalse(ui.run("verify", filename("28_buggy_simple_loop1_vf_false.c"), "-svcomp"));
	}
	
	@Test
	public void conditionals_vs_true() throws ABCException {
		assertTrue(ui.run("verify", filename("29_conditionals_vs_true.c"), "-svcomp"));
	}
	
	@Test
	public void Function_Pointer3_vs_true() throws ABCException {
		assertTrue(ui.run("verify", filename("30_Function_Pointer3_vs_true.c"), "-svcomp"));
	}
	
	@Test
	public void simple_loop5_vs_true() throws ABCException {
		assertTrue(ui.run("verify", filename("31_simple_loop5_vs_true.c"), "-svcomp"));
	}
	
	@Test
	public void pthread5_vs_false() throws ABCException {
		assertTrue(ui.run("verify", filename("32_pthread5_vs_false.c"), "-svcomp"));
	}
	
	@Test
	public void double_lock_p1_vs_true() throws ABCException {
		assertTrue(ui.run("verify", filename("33_double_lock_p1_vs_true.c"), "-svcomp"));
	}

	@Test
	public void double_lock_p2_vs_true() throws ABCException {
		assertTrue(ui.run("verify", filename("34_double_lock_p2_vs_true.c"), "-svcomp"));
	}
	
	@Test
	public void double_lock_p3_vs_true() throws ABCException {
		assertTrue(ui.run("verify", filename("35_double_lock_p3_vs_true.c"), "-svcomp"));
	}
	
	@Test
	public void stack_cas_p0_vs_true() throws ABCException {
		assertTrue(ui.run("verify", filename("36_stack_cas_p0_vs_concur_true.c"), "-svcomp"));
	}
	
	@Test
	public void stack_lock_p0_vs_true() throws ABCException {
		assertTrue(ui.run("verify", filename("37_stack_lock_p0_vs_concur_true.c"), "-svcomp"));
	}
	
	@Test
	public void rand_cas_vs_concur_true() throws ABCException {
		assertTrue(ui.run("verify", filename("38_rand_cas_vs_concur_true.c"), "-svcomp"));
	}
	
	@Test
	public void rand_lock_p0_vs_true() throws ABCException {
		assertTrue(ui.run("verify", filename("39_rand_lock_p0_vs_true.c"), "-svcomp"));
	}

	@Test
	public void barrier_vf_false() throws ABCException {
		assertFalse(ui.run("verify", filename("40_barrier_vf_false.c"), "-svcomp"));
	}
	
	@Test
	public void FreeBSD__abd_kbd__sliced_true() throws ABCException {
		assertFalse(ui.run("verify", filename("41_FreeBSD__abd_kbd__sliced_true.c"), "-svcomp"));
	}
	
	@Test
	public void FreeBSD__rdma_addr__sliced_true() throws ABCException {
		assertTrue(ui.run("verify", filename("42_FreeBSD__rdma_addr__sliced_true.c"), "-svcomp"));
	}
	
	@Test
	public void NetBSD__sysmon_power__sliced_true() throws ABCException {
		assertTrue(ui.run("verify", filename("43_NetBSD__sysmon_power__sliced_true.c"), "-svcomp"));
	}
	
	@Test
	public void Solaris__space_map__sliced_true() throws ABCException {
		assertTrue(ui.run("verify", filename("44_Solaris__space_map__sliced_true.c"), "-svcomp"));
	}
	
	@Test
	public void monabsex1_vs_true() throws ABCException {
		assertTrue(ui.run("verify", filename("45_monabsex1_vs_true.c"), "-svcomp"));
	}
	
	@Test
	public void monabsex2_vs_true() throws ABCException {
		assertTrue(ui.run("verify", filename("46_monabsex2_vs_true.c"), "-svcomp"));
	}
	
	@Test
	public void ticket_lock_hc_backoff_vs_true() throws ABCException {
		assertTrue(ui.run("verify", filename("47_ticket_lock_hc_backoff_vs_true.c"), "-svcomp"));
	}
	
	@Test
	public void ticket_lock_low_contention_vs_true() throws ABCException {
		assertTrue(ui.run("verify", filename("48_ticket_lock_low_contention_vs_true.c"), "-svcomp"));
	}
