...
public class ExamplesTest {
	...
	public void testArrays() throws IOException, PreprocessorException,
			ParseException, SyntaxException {
		TranslationUnit unit = ABC.activator(new File(rootDir, "arrays.cvl"))
				.getSideEffectFreeTranslationUnit();
		StateFactoryIF stateFactory = new StateFactory(universe);
		Model model;
		TransitionFactory transitionFactory = new TransitionFactory();
	...
	public void testChoose() throws IOException, PreprocessorException,
			ParseException, SyntaxException {
		TranslationUnit unit = ABC.activator(new File(rootDir, "choose.cvl"))
				.getSideEffectFreeTranslationUnit();
		StateFactoryIF stateFactory = new StateFactory(universe);
		Model model;
		TransitionFactory transitionFactory = new TransitionFactory();
	...
	public void testDiffusion() throws IOException, PreprocessorException,
			ParseException, SyntaxException {
		TranslationUnit unit = ABC.activator(
				new File(rootDir, "diffusion_seq.cvl"))
				.getSideEffectFreeTranslationUnit();
		StateFactoryIF stateFactory = new StateFactory(universe);
		Model model;
		TransitionFactory transitionFactory = new TransitionFactory();
	...
	public void testLocks() throws IOException, PreprocessorException,
			ParseException, SyntaxException {
		TranslationUnit unit = ABC.activator(new File(rootDir, "locks.cvl"))
				.getSideEffectFreeTranslationUnit();
		StateFactoryIF stateFactory = new StateFactory(universe);
		Model model;
		TransitionFactory transitionFactory = new TransitionFactory();
	...
	public void testMatmat() throws IOException, PreprocessorException,
			ParseException, SyntaxException {
		TranslationUnit unit = ABC.activator(new File(rootDir, "matmat.cvl"))
				.getSideEffectFreeTranslationUnit();
		StateFactoryIF stateFactory = new StateFactory(universe);
		Model model;
		TransitionFactory transitionFactory = new TransitionFactory();
	...
	public void testMinimal() throws IOException, PreprocessorException,
			ParseException, SyntaxException {
		TranslationUnit unit = ABC.activator(new File(rootDir, "minimal.cvl"))
				.getSideEffectFreeTranslationUnit();
		StateFactoryIF stateFactory = new StateFactory(universe);
		Model model;
		TransitionFactory transitionFactory = new TransitionFactory();
	...
	public void testPointers() throws IOException, PreprocessorException,
			ParseException, SyntaxException {
		TranslationUnit unit = ABC.activator(new File(rootDir, "pointers.cvl"))
				.getSideEffectFreeTranslationUnit();
		StateFactoryIF stateFactory = new StateFactory(universe);
		Model model;
		TransitionFactory transitionFactory = new TransitionFactory();
	...
	public void testSideEffects() throws IOException, PreprocessorException,
			ParseException, SyntaxException {
		TranslationUnit unit = ABC.activator(
				new File(rootDir, "sideEffects.cvl"))
				.getSideEffectFreeTranslationUnit();
		StateFactoryIF stateFactory = new StateFactory(universe);
		Model model;
		TransitionFactory transitionFactory = new TransitionFactory();
	...
	public void testSpawn() throws IOException, PreprocessorException,
			ParseException, SyntaxException {
		TranslationUnit unit = ABC.activator(new File(rootDir, "spawn.cvl"))
				.getSideEffectFreeTranslationUnit();
		StateFactoryIF stateFactory = new StateFactory(universe);
		Model model;
		TransitionFactory transitionFactory = new TransitionFactory();
