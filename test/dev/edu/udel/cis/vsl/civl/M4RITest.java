...
public class M4RITest {
	...
	public void m4riShow() {
		assertTrue(ui.run("show", "-showProgram", "-ompNoSimplify",
				...
				filename("m4ri/debug_dump.c"),
				filename("m4ri/djb.c"),
				filename("m4ri/echelonform.c"),
				filename("m4ri/graycode.c"),
				filename("m4ri/io.c"),
				filename("m4ri/misc.c"),
				filename("m4ri/mmc.c"),
				filename("m4ri/mp.c"),
				filename("m4ri/mzd.c"),
				filename("m4ri/mzp.c"),
				filename("m4ri/ple_russian.c"),
				filename("m4ri/ple.c"),
				filename("m4ri/solve.c"),
				filename("m4ri/strassen.c"),
