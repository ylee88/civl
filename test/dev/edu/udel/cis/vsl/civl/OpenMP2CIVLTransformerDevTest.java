...
public class OpenMP2CIVLTransformerDevTest {
	...
	public void vecAdd_fix() {
		assertTrue(ui.run("verify ", "-ompNoSimplify",
				"-input_omp_thread_max=2", filename("vecAdd_fix.c")));
	}
	...
	public void fft() {
		assertTrue(ui.run("verify", "-ompNoSimplify",
				"-input_omp_thread_max=2", filename("fft_openmp.c")));
	}
	...
	public void poisson() {
		assertTrue(ui.run("verify", "-ompNoSimplify",
				"-input_omp_thread_max=2", filename("poisson_openmp.c")));
	}
	...
	public void quad() {
		assertTrue(ui.run("verify", "-ompNoSimplify",
				"-input_omp_thread_max=2", filename("quad_openmp.c")));
	}
	...
	public void md() {
		assertTrue(ui.run("verify", "-ompNoSimplify",
				"-input_omp_thread_max=2", filename("md_openmp.c")));
	}
	...
	public void heatedplateAllDecomp() {
		assertTrue(ui.run("verify", "-ompNoSimplify -ompLoopDecomp=ALL", "-DMATH_NO_ASSUMPTIONS",
				"-input_omp_thread_max=2", filename("heated_plate_openmp.c")));
	}
	...
	public void heatedplateAllDecomp4() {
		assertTrue(ui.run("verify", "-ompNoSimplify -ompLoopDecomp=ALL", "-DMATH_NO_ASSUMPTIONS",
				"-input_omp_thread_max=4", filename("heated_plate_openmp.c")));
	}
	...
	public void prime() {
		assertTrue(ui.run("verify", "-ompNoSimplify",
				"-input_omp_thread_max=2", filename("prime_openmp.c")));
	}
	...
	public void fig310_mxv_omp() {
		assertTrue(ui.run("verify", "-ompNoSimplify",
				"-input_omp_thread_max=2", filename("fig310-mxv-omp.c")));
	}
	...
	public void pi() {
		assertTrue(ui.run("verify", "-ompNoSimplify", "-showProgram",
				"-input_omp_thread_max=2", filename("pi.c")));
	}
	...
	public void cmandel() {
		assertTrue(ui.run("verify", "-ompNoSimplify",
				"-input_omp_thread_max=2", filename("c_mandel.c")));
	}
	...
	public void cmd() {
		assertTrue(ui.run("verify", "-ompNoSimplify",
				"-input_omp_thread_max=2", filename("c_md.c")));
	}
	...
	public void cpi() {
		assertTrue(ui.run("verify", "-ompNoSimplify",
				"-input_omp_thread_max=2", filename("c_pi.c")));
	}
	...
	public void cfft() {
		assertTrue(ui.run("verify", "-ompNoSimplify",
				"-input_omp_thread_max=2", filename("c_fft.c")));
	}
	...
	@Test        public void cfft6() {
		assertTrue(ui.run("verify", "-ompNoSimplify",
				"-input_omp_thread_max=2", filename("c_fft6.c")));
	}
	...
	public void cjacobi01() {
		assertTrue(ui.run("verify", "-ompNoSimplify",
				"-input_omp_thread_max=2", filename("c_jacobi01.c")));
	}
	...
	public void cjacobi02() {
		assertTrue(ui.run("verify", "-ompNoSimplify",
				"-input_omp_thread_max=2", filename("c_jacobi02.c")));
	}
	...
	public void cjacobi03() {
		assertTrue(ui.run("verify", "-ompNoSimplify",
				"-input_omp_thread_max=2", filename("c_jacobi03.c")));
	}
	...
	public void clu() {
		assertTrue(ui.run("verify", "-ompNoSimplify",
				"-input_omp_thread_max=2", filename("c_lu.c")));
	}
	...
	public void dijkstra() {
		assertTrue(ui.run("verify", "-ompNoSimplify",
				"-input_omp_thread_max=2", filename("dijkstra_openmp.c")));
	}
	...
	public void helmholtz() {
		assertTrue(ui.run("verify", "-ompNoSimplify",
				"-input_omp_thread_max=2", filename("helmholtz.c")));
	}
	
	@Test
	public void mandelbrot() {
		assertTrue(ui.run("verify", "-ompNoSimplify",
				"-input_omp_thread_max=2", filename("mandelbrot_openmp.c")));
	}
	
	@Test
	public void mxm() {
		assertTrue(ui.run("verify", "-ompNoSimplify", "-showProgram",
				"-input_omp_thread_max=2", filename("mxm.c")));
	}
	...
	public void random() {
		assertTrue(ui.run("verify", "-ompNoSimplify", 
				"-input_omp_thread_max=2", filename("random_openmp.c")));
	}
	
	@Test
	public void satisfy() {
		assertTrue(ui.run("verify", "-ompNoSimplify", 
				"-input_omp_thread_max=2", filename("satisfy_openmp.c")));
	}
	
	@Test
	public void sgefa() {
		assertTrue(ui.run("verify", "-ompNoSimplify", "-showProgram",
				"-input_omp_thread_max=2", filename("sgefa_openmp.c")));
	}
	...
	public void ziggurat() {
		assertTrue(ui.run("verify", "-ompNoSimplify",
				"-input_omp_thread_max=2", filename("ziggurat_openmp.c")));
	}
