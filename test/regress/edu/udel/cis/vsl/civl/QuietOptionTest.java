...
/**
 * Test cases used to test -quiet option in the command
 * eg. verify -quiet filename
 * 
 * @author yihaoyan
 *
 */
public class QuietOptionTest {
	...
	public void adderVerify(){
		assertTrue(ui.run(TestConstants.VERIFY, "-inputB=5", TestConstants.QUIET,
				filename1("adder.cvl")));
	}
	
	@Test
	public void adderBadVerify(){
		assertFalse(ui.run(TestConstants.VERIFY, "-inputB=5", TestConstants.QUIET,
	...
	public void adderCompare(){
		assertTrue(ui.run(TestConstants.COMPARE, "-inputNB=4", "-inputNPROCSB=2",
				TestConstants.QUIET, TestConstants.IMPL,
